...
TapID listens to a short tap on an object and identifies what it's made of —
wood, metal, plastic, glass, ceramic — purely from the sound's resonant
...
Different materials ring at characteristically different frequencies, the
...
5. Report the closest-matching material
...
- Adding a new material is just recording a handful of reference taps,
  not retraining anything

## Methodology note

Reference recordings and live identification both use the same rigid
tapping implement (e.g. a 1rs coin), tapped at a consistent location on
